<template>
  <TrafficLights currentLight="green" :timer="ligthTimer" />
</template>
...
export default {
  ...
  setup() {
    ...
    const lightDuration = storageTimer && storageLight === 'green' ? ref(storageTimer) : ref(15);
    ...
    onMounted(() => setStorageLight('green'));
